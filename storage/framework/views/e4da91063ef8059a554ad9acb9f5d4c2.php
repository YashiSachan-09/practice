...
<header class="site-header sticky top-0 z-50 overflow-x-hidden backdrop-blur-xl">
    <div class="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div class="hidden items-center gap-3 xl:flex">
            ...
            <a href="<?php echo e(route('marketplace')); ?>" class="btn-primary text-sm">Browse editions</a>
        </div>
        ...
        <details class="group relative xl:hidden">
            ...
            >
                <nav class="flex flex-col gap-1" aria-label="Primary mobile">
                    ...
                    <a href="<?php echo e(route('marketplace')); ?>" class="btn-primary justify-center rounded-xl px-4 py-3 text-center text-sm">Browse editions</a>
                </nav>
            </div>
        </details>
    </div>
</header>
<?php /**PATH C:\anayra\anayra\resources\views/partials/site-header.blade.php ENDPATH**/ ?>
...
<footer class="site-panel relative mt-0 overflow-x-hidden border-t">
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid gap-12 md:grid-cols-2 xl:grid-cols-5">
            ...
            <?php $__currentLoopData = $footerSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                    <h3 class="section-kicker text-[11px] text-slate-600"><?php echo e(strtoupper($title)); ?></h3>
                    <ul class="mt-4 space-y-3 text-sm text-slate-700">
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $route]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($route !== '#'): ?>
                                <li>
                                    <a href="<?php echo e(route($route)); ?>" class="footer-link transition"><?php echo e($label); ?></a>
                                </li>
                            <?php else: ?>
                                <li><span class="cursor-not-allowed text-slate-400"><?php echo e($label); ?></span></li>
                            <?php endif; ?>
            ...
            <div class="min-w-0 max-w-full rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm sm:p-8 lg:col-span-1 dark:border-slate-600 dark:bg-slate-800/60">
                ...
                <a href="<?php echo e(route('admin.login')); ?>" class="flex items-center justify-between rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-800 transition hover:border-indigo-300 hover:bg-indigo-50">
        ...
        <div class="mt-16 flex flex-col items-start justify-between gap-4 border-t border-slate-200 pt-10 text-[11px] text-slate-500 sm:flex-row sm:items-center">
            <p>© <?php echo e(date('Y')); ?> A7 ANAYARAA Gallery & Marketplace. Concept experience — replace copy with legally binding text before launch.</p>
...
<?php /**PATH C:\anayra\anayra\resources\views/partials/site-footer.blade.php ENDPATH**/ ?>